...
const PAYMENT_CODE = 4;

/*--------------------------------------------------*/

(function (){

    let productPrice = REGULAR_PRICE; // atribui o preço do produto
    ...
    switch (PAYMENT_CODE){
        ...
        case 2: // À vista no dinheiro ou PIX, recebe 15% de desconto
            productPrice -= (productPrice * 0.15);
        break;
    ...
    console.log('O custo final do produto será R$' + productPrice); // Mostra ao usuário o preço final do produto
}) ()
